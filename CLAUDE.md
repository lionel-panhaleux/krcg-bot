...
4. Docs are AI-first — agents are the readers and reviewers. Terse, structured, one fact one home.
...
- Substantive changes get an independent agent review before commit, and pass `just test` (quality + pytest).
